...
class FFWP_BetterCheckout_Enable {
	...
	const FFWP_BETTER_CHECKOUT_REWRITE_TEXT_FIELDS = [
		...
		'The EU VAT Validation service seems to be overloaded at the moment. Please try again in a minute or deduct the calculated VAT from your next VAT declaration using the invoice you\'ll receive upon purchase.'           => 'We\'re having trouble checking your VAT number. The VIES service is unreachable.',
		'City'                                                                                                                                                                                                                    => 'Billing city',
	...
	public function __construct() {
		...
		// Modify Text Fields
		add_filter(
			'edd_checkout_personal_info_text',
			function () {
        ...
        <div id="edd_checkout_wrap">
			<?php if ( edd_get_cart_contents() || edd_cart_has_fees() ) : ?>
                ...
                <div id="ffwpress-cart__wrapper" class="cart-wrapper-mobile">
                    <a href="#edd_checkout_cart_form"
                       class="ffwpress-cart-link hide-on-desktop"><?php echo __( 'View Shopping Cart', $this->plugin_text_domain ); ?></a>
                </div>
                <div id="ffwpress-payment-details__wrapper">
                    <div id="edd_checkout_form_wrap" class="edd_clearfix">
                        <form id="edd_purchase_form" class="edd_form" action="<?php echo $form_action; ?>"
                              method="POST">
							<?php
							/**
							 ...
							 */ ?>
                            <input type="submit" class="edd-apply-discount edd-submit blue button hidden"
                                   value="Apply"/>
                        </form>
		...
		if ( $selected_gateway == 'mollie_ideal' ) : ?>
            <fieldset id="ideal-notice">
                <div class="payment-method-additional-info ideal">
                    <label>
						<?php echo __(
							'Your initial payment is processed using <strong>iDEAL</strong>. Recurring payments (if any) are collected using <strong>SEPA Direct Debit</strong> and will appear on your statement as a charge from <strong>FFW.Press via Mollie</strong> (IBAN: <strong>NL79DEUT7025543679</strong>)',
	...
	public function enqueue_scripts_and_styles() {
		...
		wp_enqueue_style(
			'ffwpress-icons',
			FFWP_PLUGIN_URL . "assets/css/ffwpress-icons$suffix.css",
			null,
			filemtime( FFWP_PLUGIN_DIR . "assets/css/ffwpress-icons$suffix.css" )
		);
		wp_enqueue_style(
			'ffwpress',
			FFWP_PLUGIN_URL . "assets/css/ffwpress$suffix.css",
			[ 'astra-child-theme-css' ],
			filemtime( FFWP_PLUGIN_DIR . "assets/css/ffwpress$suffix.css" )
		);
		...
		wp_enqueue_script(
			'ffwpress-better-checkout',
			$this->plugin_url . "assets/js/better-checkout$suffix.js",
			[
				'jquery',
				'edd-checkout-global',
			],
			filemtime( $this->plugin_dir . "assets/js/better-checkout$suffix.js" ),
			true
		);
		wp_enqueue_style(
			'ffwpress-better-checkout',
			$this->plugin_url . "assets/css/better-checkout$suffix.css",
			[ 'astra-child-theme-css' ],
			filemtime( $this->plugin_dir . "assets/css/better-checkout$suffix.css" )
		);
