...
class FFWP_BetterCheckout_Enable {
	...
	public function enqueue_scripts_and_styles() {
		...
		wp_enqueue_script( 'ffwpress-better-checkout', $this->plugin_url . "assets/js/better-checkout$suffix.js", [
			'jquery',
			'edd-checkout-global',
		],                 filemtime( $this->plugin_dir . "assets/js/better-checkout$suffix.js" ), true );
