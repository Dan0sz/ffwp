...
class FFWP_LoginFieldsLegend_Insert
{
    ...
    public function insert()
    {
        ...
        <p>
            <span class="edd-description"><?= __("Don't have an account? No worries. An account will be automatically created for you after completing your purchase.", $this->plugin_text_domain); ?></span>
        </p>
        <?php
    }
}